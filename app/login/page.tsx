      ...
      <div className="relative z-10 min-h-screen grid lg:grid-cols-[1.1fr_1fr]">
        ...
        >
          <div className="w-full max-w-md mx-auto">
            <div className="bg-surface border border-rule border-t-[3px] border-t-ink shadow-[0_1px_0_rgba(20,24,29,0.06)]">
              ...
              <form onSubmit={handleSubmit} className="px-8 py-7 space-y-5">
                ...
                <button
                  type="submit"
                  disabled={isLoading}
                  className="group w-full py-3 px-4 bg-ink text-paper inline-flex items-center justify-between gap-2 transition-colors hover:bg-[#1F2630] disabled:opacity-50"
                >
